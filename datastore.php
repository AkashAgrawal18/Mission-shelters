...
if($connection){
       $apiKey = "rzp_test_an7PnSYGyofqIN";
} else {
    echo " ERROR Connection failed";
}

mysqli_select_db($connection, 'donar_details');
...
$data = "INSERT INTO details(Name, Email, Phone_No, Address) VALUES ('$name','$email','$phone','$address' )";
